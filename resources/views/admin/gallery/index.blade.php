    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="dropdown">
                ...
                <button type="button" class="modal-trigger fw-btn-fill btn-gradient-yellow" style="width: 150px;" data-toggle="modal" data-target="#large-modal">Add Images</button>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{url('/admin/edit_gallery/'.$item->id)}}" 
            ...
            <form method="post" action="{{route('admin.storegallery')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label class="form-control-label" id="brand">Show Images</label><br>
...
<div class="modal fade" id="title-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/admin/store_gallerytitle')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Title</label>
                                <input class="form-control" type="text" placeholder="write title here" value="{{$gallerytitle==null ? '' : $gallerytitle->title}}" name="title">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Description</label>
                                <input class="form-control" type="text" placeholder="write title description here" value="{{$gallerytitle==null ? '' : $gallerytitle->desc}}" name="desc">
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function destroy(id){
        ...
        var address='{{url('/admin/store_gallery')}}'+'/'+id;
