                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{url('/edit_branch/'.$item->id)}}" 
...
<div class="modal fade" id="large-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{route('storebranch')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
...
<div class="modal fade" id="title-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/store_branchTitle')}}" >
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Title</label>
                                <input class="form-control" type="text" placeholder="write title here" value="{{$branchtitle==null ? '' : $branchtitle->title}}" name="title">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Description</label>
                                <input class="form-control" type="text" placeholder="write title description here" value="{{$branchtitle==null ? '' : $branchtitle->desc}}" name="desc">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label class="form-control-label" id="brand">Show branch Block</label><br>
                                <input type="radio" value="0" name="status" @if($branchtitle!==null): @if($branchtitle->status=='0'): checked @endif @else checked @endif>&nbsp;Show <br>
                                <input type="radio" value="1" name="status"  @if($branchtitle!==null): @if($branchtitle->status=='1'): checked @endif  @endif>&nbsp;Hide
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function destroy(id){
        ...
        var address='{{url('/store_branch')}}'+'/'+id;
