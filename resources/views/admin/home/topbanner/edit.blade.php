    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="btn-section">
                <a type="button" href="{{url('/home/topbanner')}}" class="fw-btn-fill btn-gradient-yellow" >Go Back </a>                
            </div>
        </div>
<div class="row">
	
	<form method="post" action="{{url('/home/update_topbanner/'.$homebanner->id)}}" enctype="multipart/form-data" class="test">
		@csrf
		@method('patch')
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group">
		        	...
		        	<input class="form-control" type="text" value="{{$homebanner->title}}" name="title">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label">Description</label>
		        	<input class="form-control" type="text" value="{{$homebanner->desc}}" name="desc">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label">Background Image</label>
		        	<input class="form-control" type="file" value="{{$homebanner->image}}" name="image" id="imgInp">
		        	
                    <div class="image-div">
                        <div id="originalImage">
                        	<img id='img-upload' src="{{ asset('images/banner/'.$homebanner->image) }}"/>
                        </div>
