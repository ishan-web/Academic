    ...
    <div class="card-body">
        <div class="heading-layout1">
            <div class="item-title">
                <h3>Slider Highlights</h3>
            </div>
            <div class="dropdown">
                <button type="button" class="modal-trigger fw-btn-fill btn-gradient-yellow" data-toggle="modal" data-target="#large-modal">Add New </button>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{url('/home/edit_highlights/'.$item->id)}}" 
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Highlights</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="post" action="{{route('home.storehighlights')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="" name="topic">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
...
<script type="text/javascript">
    function destroy(id){
        ...
        var address='{{url('/home/store_highlights')}}'+'/'+id;
