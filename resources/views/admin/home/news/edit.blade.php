    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="btn-section">
                <a type="button" href="{{url('/home/news')}}" class="fw-btn-fill btn-gradient-yellow" >Go Back </a>                
            </div>
        </div>
    <div class="row">
	
	<form method="post" action="{{url('/home/update_news/'.$homenews->id)}}" enctype="multipart/form-data" class="test">
		@csrf
		@method('patch')
		<div class="row">
            ...
            <div class="col-sm-6">
				<div class="form-group">
		        	...
		        	<input class="form-control" type="date" value="{{$homenews->date}}" name="date">
				</div>
            </div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label">Title</label>
		        	<input class="form-control" type="text" value="{{$homenews->title}}" name="title">
				</div>
			</div>
			<div class="col-sm-12">
				<div class="form-group">
					<label class="form-control-label">Description</label>
                    <textarea class="form-control rte" name="desc">{{$homenews->desc}}</textarea>
            ...
            <div class="col-sm-6">
                ...
                <label class="form-control-label" id="brand">Show Course</label><br>
                    <input type="radio" value="0" name="status" @if($homenews!==null): @if($homenews->status=='0'): checked @endif @else checked @endif>&nbsp;Show <br>
                    <input type="radio" value="1" name="status"  @if($homenews!==null): @if($homenews->status=='1'): checked @endif  @endif>&nbsp;Hide
                </div>
            </div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label"> Image</label>
		        	<input class="form-control" type="file" value="{{$homenews->image}}" name="image" id="imgInp">
		        	
                    <div class="image-div">
                        <div id="originalImage">
                        	<img id='img-upload' src="{{ asset('images/banner/'.$homenews->image) }}"/>
                        </div>
