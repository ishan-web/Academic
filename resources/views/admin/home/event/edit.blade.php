    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="btn-section">
                <a type="button" href="{{url('/home/event')}}" class="fw-btn-fill btn-gradient-yellow" >Go Back</a>                
            </div>
        </div>
<div class="row">
	
	<form method="post" action="{{url('/home/update_event/'.$event->id)}}" enctype="multipart/form-data" class="test">
		@csrf
		@method('patch')
		<div class="row">			
			<hr >
			...
			<div class="col-sm-12">
				<div class="form-group">
                    ...
                    <textarea class="form-control rte" name="desc">{{$event->desc}}</textarea>
			...
			<div class="col-sm-6">
				<div class="form-group">
		        	...
		        	<input class="form-control" type="file" value="{{$event->image}}" name="image" id="imgInp">
		        	
                    <div class="image-div">
                        <div id="originalImage">
                        	<img id='img-upload' src="{{ asset('images/banner/'.$event->image) }}"/>
                        </div>
