    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="dropdown">
                ...
                <button type="button" class="modal-trigger fw-btn-fill btn-gradient-yellow" style="width: 150px;" data-toggle="modal" data-target="#large-modal">Add Staff</button>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <a href="{{url('/home/edit_staff/'.$item->id)}}" 
...
<div class="modal fade" id="large-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{route('home.storestaff')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
...
<div class="modal fade" id="title-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/home/store_staffTitle')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="write title here" value="{{$homestafftitle==null ? '' : $homestafftitle->title}}" name="title">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Description</label>
                                <input class="form-control" type="text" placeholder="write title description here" value="{{$homestafftitle==null ? '' : $homestafftitle->desc}}" name="desc">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-control-label" id="brand">Show Staff Block in Home page</label><br>
                                    <input type="radio" value="0" name="status" @if($homestafftitle!==null): @if($homestafftitle->status=='0'): checked @endif @else checked @endif>&nbsp;Show <br>
                                    <input type="radio" value="1" name="status"  @if($homestafftitle!==null): @if($homestafftitle->status=='1'): checked @endif  @endif>&nbsp;Hide
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-control-label" id="brand">Show Staff Block in about us page</label><br>
                                    <input type="radio" value="0" name="stat" @if($homestafftitle!==null): @if($homestafftitle->stat=='0'): checked @endif @else checked @endif>&nbsp;Show <br>
                                    <input type="radio" value="1" name="stat"  @if($homestafftitle!==null): @if($homestafftitle->stat=='1'): checked @endif  @endif>&nbsp;Hide
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function destroy(id){
        ...
        var address='{{url('/home/store_staff')}}'+'/'+id;
