    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="btn-section">
                <a type="button" href="{{url('/home/staff')}}" class="fw-btn-fill btn-gradient-yellow" >Go Back </a>                
            </div>
        </div>
    <div class="row">
	
	<form method="post" action="{{url('/home/update_staff/'.$homestaff->id)}}" enctype="multipart/form-data" class="test">
		@csrf
		@method('patch')
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="form-group">
		        	...
		        	<input class="form-control" type="text" value="{{$homestaff->title}}" name="title">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label">Position</label>
		        	<input class="form-control" type="text" value="{{$homestaff->desc}}" name="desc">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<label class="form-control-label"> Image</label>
		        	<input class="form-control" type="file" value="{{$homestaff->image}}" name="image" id="imgInp">
		        	
                    <div class="image-div">
                        <div id="originalImage">
                        	<img id='img-upload' src="{{ asset('images/banner/'.$homestaff->image) }}"/>
                        </div>
