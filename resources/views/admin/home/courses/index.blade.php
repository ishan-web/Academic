    ...
    <div class="card-body">
        <div class="heading-layout1">
            ...
            <div class="dropdown">
                ...
                <button type="button" class="modal-trigger fw-btn-fill btn-gradient-yellow" style="width: 150px;" data-toggle="modal" data-target="#large-modal">Add Services</button>
            </div>
        </div>
            ...
            <table class="table display data-table text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->desc }}</td>
                        <td>
                            <img class="img-fluid shadow-lg rounded-3" src="{{asset('images/banner/'.$item->img)}}" width="150px" height="100px" alt="">
                        </td>
                        @if($item->status == 0)
                        ...
                        <td class="align-middle">
                            <a href="{{url('/home/edit_courses/'.$item->id)}}" 
...
<div class="modal fade" id="large-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="min-width: 120%;">
            ...
            <form method="post" action="{{route('home.storecourses')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" value="" id="imgInp" name="img">
...
<div class="modal fade" id="title-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{url('/home/store_coursetitle')}}" enctype="multipart/form-data">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Title</label>
                                <input class="form-control" type="text" placeholder="write title here" value="{{$courseTitle==null ? '' : $courseTitle->title}}" name="title">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="form-control-label">Description</label>
                                <input class="form-control" type="text" placeholder="write title description here" value="{{$courseTitle==null ? '' : $courseTitle->desc}}" name="desc">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label class="form-control-label" id="brand">Show Course Block</label><br>
                                <input type="radio" value="0" name="status" @if($courseTitle!==null): @if($courseTitle->status=='0'): checked @endif @else checked @endif>&nbsp;Show <br>
                                <input type="radio" value="1" name="status"  @if($courseTitle!==null): @if($courseTitle->status=='1'): checked @endif  @endif>&nbsp;Hide
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function destroy(id){
        ...
        var address='{{url('/home/store_courses')}}'+'/'+id;
